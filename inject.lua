...
-- INTEGRASI BARU: Tombol Clear Workspace ala LangzUpload
...
-- [[ CORE ENGINE COPY/PASTE WITH LANGZ ENGINE INTEGRATION ]]
            ...
            FileSelectBtn.MouseButton1Click:Connect(function()
                ...
                task.spawn(function()
                    local success, err = pcall(function()
                        ...
                        -- ==================================================
                        setStatus("Langz Engine: Processing Parts...", Color3.fromRGB(255, 185, 55))
                        processParts(MasterFolder) -- Pengangkuran & Render Precise otomatis
                        
                        setStatus("Langz Engine: Unlocking Scripts...", Color3.fromRGB(255, 185, 55))
